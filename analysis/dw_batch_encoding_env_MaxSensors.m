...
maxSensorsFiles = dir(fullfile(analysis_folder,'Env_maxSensors_subj*.mat'));
fs_new = 64;
...
%     [pred, stats] = mTRFpredict(all_audio_stim,all_audio_resp,average_audio_model)
    ...
    save(fullfile(analysis_folder,['maxModelAccuracy_' subject2process '.mat']),'rmax_audio','rmax_visualLow','rmax_visualHigh','lambda','cv_audio','cv_visualLow','cv_visualHigh','lambdas','tmin','tmax','average_audio_model','average_visualLow_model','average_visualHigh_model');
    saveas(200,fullfile(analysis_folder,['maxModelAccuracy_' subject2process '_Audio' '.png']));
    saveas(300,fullfile(analysis_folder,['maxModelAccuracy_' subject2process '_VisualLow' '.png']));
    saveas(400,fullfile(analysis_folder,['maxModelAccuracy_' subject2process '_VisualHigh' '.png']));
    saveas(500,fullfile(analysis_folder,['maxModelWeights_' subject2process '_Audio' '.png']));
    saveas(600,fullfile(analysis_folder,['maxModelWeights_' subject2process '_VisualLow' '.png']));
    saveas(700,fullfile(analysis_folder,['maxModelWeights_' subject2process '_VisualHigh' '.png']));
