...
%     saveas(100,fullfile(analysis_folder,['regressors_' subject2process '_b' blocks2process{b} '_chapter' num2str(chapter) '_' condition '_' MOT_load '.png']));
    ...
    save(fullfile(analysis_folder,['surprisal_modelAccuracy_' subject2process '.mat']),'rmax_audio','rmax_visualLow','rmax_visualHigh','lambda','cv_audio','cv_visualLow','cv_visualHigh','lambdas','tmin','tmax','average_audio_model','average_visualLow_model','average_visualHigh_model');
    saveas(200,fullfile(analysis_folder,['surprisal_modelAccuracy_' subject2process '_Audio' '.png']));
    saveas(300,fullfile(analysis_folder,['surprisal_modelAccuracy_' subject2process '_VisualLow' '.png']));
    saveas(400,fullfile(analysis_folder,['surprisal_modelAccuracy_' subject2process '_VisualHigh' '.png']));
    saveas(500,fullfile(analysis_folder,['surprisal_modelWeights_' subject2process '_Audio' '.png']));
    saveas(600,fullfile(analysis_folder,['surprisal_modelWeights_' subject2process '_VisualLow' '.png']));
    saveas(700,fullfile(analysis_folder,['surprisal_modelWeights_' subject2process '_VisualHigh' '.png']));
